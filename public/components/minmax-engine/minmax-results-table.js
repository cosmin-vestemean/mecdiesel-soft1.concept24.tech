...
const INTERVAL_FIELDS = [
  ...
  { key: 'stocFizicQty', label: 'Stoc fizic' },
  { key: 'transferInQty', label: 'Transfer in drum' },
  { key: 'stocQty', label: 'Stoc efectiv' },
...
const RESULT_COLUMNS = [
  ...
  { key: 'STOC_FIZIC_QTY', label: 'Stoc fizic', sortField: 'stocFizicQty', type: 'number' },
  { key: 'TRANSFER_IN_QTY', label: 'Transfer in drum', sortField: 'transferInQty', type: 'number' },
  { key: 'STOC_QTY', label: 'Stoc efectiv', sortField: 'stocQty', type: 'number' },
