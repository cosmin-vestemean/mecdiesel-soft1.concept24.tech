...
export class MinmaxEngineService {
  ...
  async params (data) {
    ...
    const [paramsRes, covRes, branchRes, overrideRes] = await Promise.all([
      ...
      this._execSql(`SELECT b.BRANCH, b.MARIME, b.INCLUS, b.ESTE_HQ, b.ESTE_PODEA, b.UPDATEDAT, COALESCE(br.NAME, '') AS NAME FROM CCCMINMAXBRANCH b LEFT JOIN BRANCH br ON br.BRANCH = b.BRANCH AND br.COMPANY = ${COMPANY} ORDER BY b.BRANCH`, [], token),
