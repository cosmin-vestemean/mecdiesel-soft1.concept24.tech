...
const pairs = [
    ...
    ['getPurgeSelectorSql', 'new_min_max/sql/00k_purge_selector.sql'],
    ['getPurgeRetentionSql', 'new_min_max/sql/00l_purge_retention.sql'],
    ['getEnsureBackfillJobProcedureSql', 'new_min_max/sql/00m_ensure_backfill_job.sql'],
